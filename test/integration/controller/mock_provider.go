...
func (p *mockProvider) EnsureStaticNodePools(ctx context.Context, reservationName, gscBlockName, nodepoolName string, numSubblocks int, nodepoolConfig *cloud.StaticNodePoolConfig, concurrency int) error {
	p.Lock()
	defer p.Unlock()
